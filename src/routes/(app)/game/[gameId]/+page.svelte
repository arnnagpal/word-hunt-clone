...
<div class="flex flex-col justify-between items-center">
    ...
    <div class="flex flex-col items-center h-1/4">
        <!--		game header   -->
        <GameHeader bind:score={score} bind:words={wordCount} on:timeup={timeOver} time={data.time}/>
    </div>
    ...
    <div class="flex flex-col items-center h-[85vh]">
        <div>
            <Game bind:disabled={gameDisabled} board={data.board} on:endDrag={endDragEvent} on:score={scoreChange}
